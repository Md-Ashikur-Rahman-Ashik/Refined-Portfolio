...
export default function PortfolioHome() {
  return (
    <>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-slate-800 pb-12">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-base text-slate-400 leading-relaxed font-mono">
                Specializing in localized state management engines, dynamic
                event loop optimizations, and highly scalable data serialization
                layouts.
              </p>
            </div>
        ...
        <section className="max-w-5xl mx-auto px-6">
          <div className="mb-8">
            ...
            <p className="text-sm text-slate-400 mt-2 max-w-3xl">
              ...
              simulator demonstrating how shifting architectural models
              completely resolved browser layout jank.
            </p>
          </div>
        </section>
      ...
      <footer className="w-full max-w-5xl mx-auto border-t border-slate-900 mt-24 pb-12 pt-8 px-6 text-xs font-mono text-slate-500 flex flex-col sm:flex-row justify-between items-center gap-4">
        <div>
